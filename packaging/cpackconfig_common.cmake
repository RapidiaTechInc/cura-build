if(CURA_BUILDTYPE STREQUAL "")
    cpack_add_component(_cura
                DISPLAY_NAME "ExOne Cura"
                Description "ExOne Cura Executable and Data Files"
                REQUIRED
    )
else()
    cpack_add_component(_cura
                DISPLAY_NAME "ExOne Cura ${CURA_BUILDTYPE}"
                Description "ExOne Cura ${CURA_BUILDTYPE} Executable and Data Files"
                REQUIRED
    )
endif()
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_PACKAGE_NAME "ExOne Cura")
else()
    set(CPACK_PACKAGE_NAME "ExOne Cura ${CURA_BUILDTYPE}")
endif()
string(REPLACE " " "_" CPACK_FILE_NAME_NO_SPACES "${CPACK_PACKAGE_NAME}")

set(CPACK_PACKAGE_VENDOR "ExOne Tech")
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_PACKAGE_NAME "ExOne Cura ${CURA_FULL_VERSION}")
else()
    set(CPACK_PACKAGE_NAME "ExOne Cura ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
endif()

set(CPACK_PACKAGE_ICON "${CMAKE_SOURCE_DIR}/packaging/cura.ico")
set(CPACK_PACKAGE_DESCRIPTION_SUMMARY "ExOne Cura")
...
if(CURA_BUILDTYPE STREQUAL "")
    set(CPACK_CREATE_DESKTOP_LINKS Cura "ExOne Cura ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_EXECUTABLES Cura "ExOne Cura ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "ExOne Cura ${CURA_FULL_VERSION}")
else()
    set(CPACK_CREATE_DESKTOP_LINKS Cura "ExOne Cura ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_EXECUTABLES Cura "ExOne Cura ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
    set(CPACK_PACKAGE_INSTALL_DIRECTORY "ExOne Cura ${CURA_BUILDTYPE} ${CURA_FULL_VERSION}")
endif()
