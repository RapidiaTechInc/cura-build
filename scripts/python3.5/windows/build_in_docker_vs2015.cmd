...
echo CURA_MARKETPLACE_ROOT       = "%CURA_MARKETPLACE_ROOT%"
echo CURA_DIGITAL_FACTORY_URL    = "%CURA_DIGITAL_FACTORY_URL%"
echo
...
copy /y "ExOne_Cura*.exe" %CURA_BUILD_OUTPUT_PATH%\
copy /y "ExOne_Cura*.msi" %CURA_BUILD_OUTPUT_PATH%\
